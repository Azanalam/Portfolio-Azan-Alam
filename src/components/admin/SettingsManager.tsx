    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="bg-[#0A0A0A] border border-[#1A1A1A] rounded-xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Site Name</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Site Logo Initials</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Accent Theme Color</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Interface Theme Mode</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Timezone Scope</label>
                <input
                  type="text"
            ...
            <div className="space-y-1.5 pt-2">
              <label className="text-[10px] font-mono font-bold text-[#71717A] uppercase tracking-wider block">Copyright Phrase</label>
              <input
                type="text"
          ...
          <div className="bg-[#0A0A0A] border border-[#1A1A1A] rounded-xl p-6 space-y-4">
            ...
            <div className="space-y-3 max-h-56 overflow-y-auto pr-1">
              {Object.entries(settings.socialLinks).map(([platform, url]) => (
                <div key={platform} className="flex items-center gap-2 bg-[#111] border border-[#1A1A1A] p-2 rounded-lg justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[#A1A1AA] truncate max-w-sm font-mono">{url}</span>
                  </div>
                  <button
            ...
            <div className="bg-[#111] border border-[#1A1A1A]/80 p-3 rounded-xl space-y-3.5">
              <div className="text-[10px] font-mono uppercase tracking-widest text-[#71717A] font-bold">Inject Social Media Platform</div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <input
                  ...
                  className="bg-[#0A0A0A] border border-[#1A1A1A] text-white rounded-lg px-2.5 py-1.5 text-[11px] focus:outline-none focus:border-emerald-500 font-mono"
                />
                <input
                  type="url"
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white hover:bg-neutral-100 text-black font-bold text-[10px] uppercase tracking-wider rounded transition cursor-pointer"
              >
        ...
        <div className="lg:col-span-5">
          <div className="bg-[#0A0A0A] border border-[#1A1A1A] rounded-xl p-6 space-y-4 h-full">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider font-mono border-b border-[#1A1A1A] pb-2 text-emerald-500 flex items-center gap-2">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center justify-between p-3 border rounded-xl transition font-mono text-xs ${
                      isHidden
                        ? 'bg-[#111]/40 text-[#52525B] border-[#1A1A1A]'
                        : 'bg-[#111] text-white border-[#222]'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] text-[#52525B] font-bold">#{idx + 1}</span>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="w-px h-3.5 bg-[#27272A] mx-1" />
